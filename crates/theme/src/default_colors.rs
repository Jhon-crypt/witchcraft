...
pub(crate) fn witchcraft_cyan() -> ColorScaleSet {
    StaticColorScaleSet {
        scale: "WitchcraftCyan",
        light: [
            "#f0fcfeff",
            "#e0f9fdff",
            "#c4f3fbff",
...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            border_focused: witchcraft_cyan().light().step_5(),
            border_selected: witchcraft_cyan().light().step_5(),
            ...
            element_selection_background: witchcraft_cyan().light().step_3().alpha(0.25),
            drop_target_background: witchcraft_cyan().light_alpha().step_2(),
            ...
            panel_focused_border: witchcraft_cyan().light().step_10(),
            ...
            pane_focused_border: witchcraft_cyan().light().step_5(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            border_focused: witchcraft_cyan().dark().step_5(),
            border_selected: witchcraft_cyan().dark().step_5(),
            border_transparent: system.transparent,
            ...
            element_selection_background: witchcraft_cyan().dark().step_3().alpha(0.25),
            drop_target_background: witchcraft_cyan().dark_alpha().step_2(),
            ...
            text_accent: witchcraft_cyan().dark().step_11(),
            ...
            icon_accent: witchcraft_cyan().dark().step_11(),
            debugger_accent: red().light().step_10(),
            ...
            panel_focused_border: witchcraft_cyan().dark().step_8(),
            ...
            pane_focused_border: witchcraft_cyan().dark().step_5(),
