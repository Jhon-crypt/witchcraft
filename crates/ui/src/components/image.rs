                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Default",
                                Vector::square(VectorName::WitchcraftLogo, size).into_any_element(),
                            ),
                            single_example(
                                "Custom Size",
                                h_flex()
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Accent Color",
                                Vector::square(VectorName::WitchcraftLogo, size)
                                    .color(Color::Accent)
                                    .into_any_element(),
                            ),
                            single_example(
...
mod tests {
    ...
    #[test]
    fn vector_path() {
        assert_eq!(VectorName::WitchcraftLogo.path().as_ref(), "images/witchcraft_logo.svg");
    }
}
