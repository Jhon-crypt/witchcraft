...
AppPublisher=Witchcraft
AppPublisherURL=https://www.witchcraft.dev/
AppSupportURL=https://www.witchcraft.dev/
AppUpdatesURL=https://www.witchcraft.dev/
...
[Files]
Source: "{#ResourcesDir}\Witchcraft.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\witchcraft\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Witchcraft.exe,1"
Root: HKCU; Subkey: "Software\Classes\witchcraft\shell\open\command"; ValueType: "string"; ValueData: """{app}\Witchcraft.exe"" ""%1"""
